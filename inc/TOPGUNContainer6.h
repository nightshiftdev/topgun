...
#ifndef TOPGUNContainer6_H
#define TOPGUNContainer6_H
...
/**
*  CTOPGUNContainer6  container control class.
*  
*/
class CTOPGUNContainer6 : public CCoeControl, MCoeControlObserver
    {
    ...
    public: // New functions
	    ...
	    * @result void.
	    */
		void SetView(CTOPGUNView6* aView);
