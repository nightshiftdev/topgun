...
#ifndef TOPGUNCONTAINER5_H
#define TOPGUNCONTAINER5_H
...
/**
*  CTOPGUNContainer5  container control class.
*  
*/
class CTOPGUNContainer5 : public CCoeControl, MCoeControlObserver
    {
    ...
    public: // New functions
	    ...
	    * @result void.
	    */
		void SetView(CTOPGUNView5* aView);
