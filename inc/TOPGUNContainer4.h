...
#ifndef TOPGUNCONTAINER4_H
#define TOPGUNCONTAINER4_H
...
/**
*  CTOPGUNContainer4  container control class.
*  
*/
class CTOPGUNContainer4 : public CCoeControl, MCoeControlObserver
    {
    ...
    public: // New functions
	    ...
	    * @result void.
	    */
		void SetView(CTOPGUNView4* aView);
